...
#docker run --rm -iv $(pwd):/home registry.scicore.unibas.ch/schwede/openstructure:latest try.py >> output_single_residue_cry_ABB_H_lddt.txt
...
for chain in chains:
    ...
    #                                !!!!!!!!!!      IMPORTANT      !!!!!!!!
    ############################################################################################
    file_name = "name_single_res_lldt_" + chain + "_crystal_IgFold.csv"
    ##############################################################################################
